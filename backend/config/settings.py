"""
Django settings for NEUROSPECTRA project.
"""
...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-neurospectra-clinical-pediatric-key-2026')
